...
const ANNOUNCEMENTS = [
  {
    ...
    version: '3.1.0',
    date: '2026-09-26',
    title: '\u{1F5C2} 付箋の「消去」は「アーカイブ」になりました',
    body: `
      <p><b>▼ 付箋は消えなくなりました</b>（CarFlow・PitFlow・MHS とも同じです）</p>
      <ul>
        <li>付箋の <b>⋮ の「消去」は「アーカイブ」</b>になりました。押すとボードから外れますが、<b>消えません。</b></li>
        <li><b>終わった付箋は、今までどおり「済」にしてください。</b>済から3日たつと、自動でアーカイブに入ります。</li>
        <li>ボード右上の <b>［🗂 アーカイブ済付箋］</b> で、アーカイブした付箋を見られます。一番上の欄で<b>検索</b>もできます。</li>
        <li>アーカイブから <b>「戻す」</b>を押すと、未済に戻ってボードに出ます。</li>
      </ul>
      <p><b>▼ 自動で片付くもの</b></p>
      <ul>
        <li>済から<b>3か月</b>で、付けた画像・PDF が消えます（付箋の文字は残ります）。</li>
        <li>済から<b>1年</b>で、付箋が片付きます。<b>車に付いた付箋は、その車が見えている間は残ります。</b></li>
      </ul>`
  },
  {
    id: 'a-20260925-v300',
    version: '3.0.0',
    date: '2026-09-25',
    title: '\u{1F5A5} 車両詳細が大きく・見やすくなりました（パソコン・タブレット）',
    body: `
      <p><b>\u25BC 車両詳細を開くと、画面いっぱい近くの大きさで出ます</b>（パソコン・タブレット）</p>
      <ul>
        <li>上の帯に <b>写真・メーカー 車種 グレード・管理番号など・日数・金額・お客様名</b> がまとまっています。</li>
        <li><b>写真を押すと大きく</b>表示されます。</li>
        <li>下は左右に分かれています。<b>左＝メモ・付箋／フロー</b>、<b>右＝大タスク／装備詳細</b>。上のタブで切りかえます。</li>
        <li>左の「メモ・付箋」には、<b>その車の管理番号が書いてある付箋</b>も並びます。</li>
        <li>左の「フロー」は、<b>いつ・誰が・何をしたか</b>が新しい順に並びます（操作すると自動で残ります）。</li>
        <li>売約後の車は、右のタブの一番右に <b>「展示フェーズ」</b>（売約前のタスク。見るだけ）があります。</li>
        <li>左右の境目の線を<b>ドラッグすると幅を変えられます</b>（ダブルクリックで元に戻ります）。</li>
        <li>見出しの <b>［👁 1カラム表示］</b> で今までの形に戻せます。今までの形の見出しの <b>［👁 2カラム表示］</b> で新しい形へ。</li>
        <li>車両詳細の編集は、見出しの <b>［⚙ 編集］</b> からです。</li>
      </ul>
      <p><b>\u25BC 変わっていないこと</b></p>
      <ul>
        <li>大タスクの中身と押し方は<b>今までとまったく同じ</b>です。</li>
        <li>スマホは今までどおりの形です。</li>
      </ul>`
  },
  {
    id: 'a-20260908-v2560',
    ...
    body: `
      ...
      <p><b>\u25BC 同期が切れたら、自分でつなぎ直します</b></p>
      <ul>
        <li>これまでは<b>同期が一度切れると、画面を開き直すまで更新が来ませんでした</b>
            （しかも画面は普通に動くので気づけませんでした）。</li>
        <li>これからは<b>自動でつなぎ直し</b>、つながったら<b>その間のぶんを読み直します</b>。</li>
        <li>右上のランプが <b>「同期」／「同期待ち」／「同期が切れました」</b> で変わります。
            <b>「同期待ち」のまま動かない時は、画面を開き直してください。</b></li>
      </ul>`
  },
  {
    id: 'a-20260819-fusen',
